...
import os, tarfile, numpy, math, networkx, queue, random,traceback, jsonpickle
...
class Sample:
    ...
    def get_simulation_time(self):
        """
        Return the simulation time of this Sample instance.
        """
        
        return self.simulation_time

    def get_simulation_memory(self):
        """
        Return the simulation memory used of this Sample instance.
        """
    ...
    def get_slices(self):
        """
        Returns the slices of this Sample instance.
        """
    ...
    def get_slice(self, id):
        """
        Returns the slice of this Sample instance with id.
        """
        
        return self.slices[id]

    def get_slice_flows(self, id):
        """
        Returns the flows of the slice of this Sample instance with id.
        """
        
        return self.slices[id].flows
    
    def get_slice_delta(self, id):
        """
        Returns the delta of the slice of this Sample instance with id.
        """
        
        return self.slices[id].delta
    
    def get_slice_type(self, id):
        """
        Returns the type of the slice of this Sample instance with id.
        """
        
        return self.slices[id].type

    def get_slice_number(self, id):
        """
        Returns the number of the slice of this Sample instance with id.
        """
        
        return self.slices[id].number
    ...
    def _set_slices(self, s):
        """
        Sets the slices of this Sample instance.
        """
...
class DatanetAPI:
        ...
        for root, file in tuple_files:
            try:
                ...
                while(True):
                    ...
                    s._slices_file = os.path.join(root,"slices",used_files[3])
                    ...
                    #SLICES FILE READ
                    with open(s._slices_file, 'r') as f:
                        slices = f.readline()
                        s._set_slices(jsonpickle.decode(slices))
    ...
    def _process_flow_results(self, s):
        ...
        s.memory_used = int(s._status_line.split(";")[3].split(":",1)[1])
